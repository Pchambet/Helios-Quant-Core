...
def test_discharge_within_limits():
...
def test_power_constraint_violation():
    battery = BatteryAsset(capacity_mwh=10, max_charge_mw=5, max_discharge_mw=5)
...
def test_energy_constraint_violation_overcharge():
...
def test_energy_constraint_violation_overdischarge():
