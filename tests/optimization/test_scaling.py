...
def test_scaling_inversion() -> None:
    scaler = PriceScaler((-1.0, 1.0))
    raw_prices = np.array([10.0, 50.0, 100.0])
    ...
    np.testing.assert_almost_equal(inverted, raw_prices, decimal=5)
